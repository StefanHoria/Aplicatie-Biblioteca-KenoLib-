...
> secțiunea [Releases](https://github.com/StefanHoria/KenoLib-Library-Manager/releases).
...
Proiectul are o suită de teste automate pe `pytest` — **126 de teste în 15 fișiere**, care acoperă
serviciul de API, validarea ISBN și a câmpurilor, împrumuturile și disponibilitatea exemplarelor,
rezervările, rapoartele, backup-ul și auto-backup-ul, pagina de setări și detaliile de interfață.
